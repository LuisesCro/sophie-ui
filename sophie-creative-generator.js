...
async function generateAsset(asset,sourceImages,opts){
  ...
  return ACTIVE_PROVIDER.generateImage({slot:asset.slot,prompt:asset.prompt,negativePrompt:asset.negativePrompt,sourceImages:A(sourceImages),width:2000,height:2000,mode:asset.type,preserveProduct:true,quality:O(opts)?opts.quality:undefined});
}
